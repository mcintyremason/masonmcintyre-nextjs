...
const ToyStoryDeck: Array<MatchCardProps> = [
  {
    ...
    imgSrc: "/img/card-matcher/woody.jpg",
    selected: false,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/buzz-lightyear.jpg",
    selected: false,
  },
  {
    id: 4,
  ...
  },
  {
    ...
    value: "Lil Bo Peep",
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/bo-peep.jpg",
    selected: false,
  },
  {
    id: 6,
  ...
  },
  {
    ...
    value: "Forky",
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/forky.jpg",
    selected: false,
  },
  {
    id: 8,
  ...
  },
  {
    ...
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/mr-potato-head_700x352.jpg",
    selected: false,
  },
  {
    id: 10,
  ...
  },
  {
    ...
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/mrs-potato-head.webp.jpg",
    selected: false,
  },
  {
    id: 12,
  ...
  },
  {
    ...
    value: "Slinky Dog",
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/slinky-dog.jpg",
    selected: false,
  },
  {
    id: 14,
  ...
  },
  {
    ...
    value: "aliens",
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/aliens.jpg",
    selected: false,
  },
  {
    id: 16,
  ...
  },
  {
    ...
    value: "Army Men",
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/army-men-toy-story-1.jpg",
    selected: false,
  },
  {
    id: 18,
  ...
  },
  {
    ...
    value: "Rex",
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/rex.jpg",
    selected: false,
  },
  {
    id: 20,
  ...
  },
  {
    ...
    value: "Bullseye",
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/bullseye.jpg",
    selected: false,
  },
  {
    id: 22,
  ...
  },
  {
    ...
    value: "Hamm",
    order: Math.floor(Math.random() * 24),
    imgSrc: "/img/card-matcher/hamm.jpg",
    selected: false,
  },
  {
    id: 24,
