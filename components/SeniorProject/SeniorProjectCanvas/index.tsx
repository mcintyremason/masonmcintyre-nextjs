...
const SeniorProjectCanvas: React.FC<SeniorProjectCanvas> = (
  _: SeniorProjectCanvas,
) => {
  ...
  const canvasOnClick = (
    _: React.MouseEvent<HTMLCanvasElement, MouseEvent>,
  ) => {
    ...
    if (ctx) {
      ...
      setPlayer(
        new Player(
          ...
          "lucas",
          "run",
          "/img/literacy-game/maleCharacter.png",
        ),
      );
      ...
      setShadowPlayer(
        new Player(
          ...
          "shadow",
          "run",
          "/img/literacy-game/maleShadowCharacter.png",
        ),
      );
