...
const SeniorProjectCanvas: React.FC<SeniorProjectCanvas> = (props: SeniorProjectCanvas) => {
  const [ctx, setCtx] = useState<CanvasRenderingContext2D>(null)
  const [rect, setRect] = useState<DOMRect>(null)
  const [reDraw, setReDraw] = useState<boolean>(false)
  const [background, setBackground] = useState<string>('#43B4FB')
  ...
  const canvasOnClick = (e: React.MouseEvent<HTMLCanvasElement, MouseEvent>) => {
